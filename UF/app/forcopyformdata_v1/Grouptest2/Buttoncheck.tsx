...
const Buttoncheck = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "f60e3a6a2f414d8ebefb169013d33853",
          isTable: false,
          from:"Buttoncheck",
  ...
  const handleClick=async()=>{
    if(test201527Props?.validation==true && test201527Props?.required==true || test201527Props?.required==true)
    {
 ...
 if (check33853?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `7 / 9`,gridRow: `19 / 29`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className="w-full "
          onClick={handleClick}
          view='action'
          size='s'           
          disabled= {check33853?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("check")}
        </Button>
