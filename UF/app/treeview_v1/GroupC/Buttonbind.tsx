...
const Buttonbind = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "12673f3e942740e9abf70350dec9f0e3",
          isTable: false,
          from:"Buttonbind",
  ...
  const handleClick=async()=>{
    if(c2e6b8Props?.validation==true && c2e6b8Props?.required==true || c2e6b8Props?.required==true)
    {
    ...
    try{  
    // setc2e6b8({ ...c2e6b8, treedata:allData });           
    setFileBindFlag(true);
    setFileBind((pre:any)=>({
      ...pre,
      readFunction: setc2e6b8,
      stateName: c2e6b8,
      mainControlName:'treedata'
    }))
      await delay(1000);
 ...
 if (bind9f0e3?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `2 / 4`,gridRow: `84 / 94`, gap:``, height: `100%`, overflow: 'auto'}} >
      <Modal
        open={fileBindFlag}
      ...
      >
        ...
        <Button 
          ...
          view='action'
          size='s'           
          disabled= {bind9f0e3?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("bind")}
        </Button>
