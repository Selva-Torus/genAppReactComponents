...
import GroupC  from "./GroupC/GroupC";


export default function PageTreeviewV1() {
  ...
  async function securityCheck() {
    const orchestrationData = await AxiosService.post("/UF/Orchestration",{key:"CK:CT293:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:treeview:AFVK:v1",accessProfile:[user],from:"pageTreeviewV1"},{
      headers: {
  ...
  "events": {}
        ...
        try{
          ...
          allowedGroup.map((nodes:any)=>{
            if(nodes?.groupName == 'C' && (nodes?.security== 'AA' || nodes?.security == 'ATO'))
            {
              setCheckc(true)
            }
          })
