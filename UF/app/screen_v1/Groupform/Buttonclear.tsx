...
const Buttonclear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "549f157661ad49f997c7b0f7ab3835e9",
          isTable: false,
          from:"Buttonclear",
 ...
 if (clear835e9?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `4 / 6`,gridRow: `10 / 20`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className="w-full "
          onClick={handleClick}
          view='outlined-info'
          size='s'           
          disabled= {clear835e9?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("clear")}
        </Button>
